...
{
    /**
     * @type string Action the rule applies to
     */
    protected $action;

    /**
     * @type boolean True defines a privilege, false defines a restriction
     */
    protected $behavior;

    /**
     * @type array Array of conditions (closures) to check rule against
     */
